      ...
      <section className="px-4 py-16 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              See what our users have to say about The Cash Book
            </p>
          </motion.div>
          <motion.div
            initial="hidden"
            ...
            {[
              {
                ...
                avatar: "SM",
                rating: 5,
                review: "Finally, an app that makes splitting trip expenses painless! Our group of 8 used it for our Europe trip and settling up took 2 minutes.",
              },
              {
                name: "James K.",
                role: "Roommate",
                avatar: "JK",
                rating: 5,
                review: "We use Cash Book for all our apartment expenses. Rent, utilities, groceries - everything is tracked and fair. No more awkward money conversations!",
              },
              {
                name: "Priya R.",
                ...
                avatar: "PR",
                rating: 5,
                review: "Organized a wedding with 15 contributors. The settlement optimization feature saved us from dozens of individual transfers. Brilliant!",
              },
              {
                name: "Mike T.",
                ...
                avatar: "MT",
                rating: 4,
                review: "Perfect for our regular camping trips. The receipt scanning works like magic - just snap and go. Saves so much time!",
              },
              {
                name: "Lisa C.",
                role: "Digital Nomad",
                avatar: "LC",
                rating: 5,
                review: "The multi-currency support is a lifesaver when traveling with friends across different countries. Exchange rates are always accurate.",
              },
              {
                name: "David W.",
                role: "Team Lead",
                avatar: "DW",
                rating: 5,
                review: "We use it for team lunches and office events. Clean interface, easy to use, and everyone always knows where they stand financially.",
              },
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <motion.div
                    ...
                    className="w-10 h-10 rounded-full bg-primary/10 text-primary font-semibold flex items-center justify-center text-sm"
                  >
                    {testimonial.avatar}
                  </motion.div>
                  <div>
